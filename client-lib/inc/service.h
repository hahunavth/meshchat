...
extern int _get_conv_list(const int limit, const int offset, uint32_t *_idls, uint32_t *_len);
...
extern int _get_msg_all(const int limit, const int offset, const uint32_t conv_id, uint32_t chat_id, uint32_t *_msg_idls, uint32_t *_len);
extern int _get_msg_detail(const uint32_t msg_id, response_msg *_msg);
extern int _send_msg_text(
    const uint32_t conv_id,
    const uint32_t chat_id, const uint32_t reply_to, const char *msg,
    uint32_t *_msg_id);
extern int _send_msg_file(
    const uint32_t conv_id,
    const uint32_t chat_id, const uint32_t reply_to, const char *msg,
    uint32_t *_msg_id);
